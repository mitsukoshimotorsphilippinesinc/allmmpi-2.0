	...
	genealogy.templates.popover = "<div id='genealogy-popover-info' class='genealogy-popup'> \
		...
		<div class='genealogy-popup-container'> \
			...
			<div class='genealogy-action'> \
				...
				<button class='btn btn-super-tiny btn-genealogy-message' data-member-account-id='<%= member_account_id %>' data-member-fullname='<%= propername %>'><i class='icon-envelope'></i> Send PM &nbsp;</button> \
			</div> \
		</div> \
	</div>";
	...
	genealogy.templates.popoverUpgrade = "<div id='genealogy-popover-info' class='genealogy-popup'> \
		...
		<div class='genealogy-popup-container'> \
			...
			<div class='genealogy-action'> \
				<button class='btn btn-super-tiny btn-genealogy-network'><i class='icon-search'></i> View Network &nbsp;</button> \
				<button class='btn btn-super-tiny btn-genealogy-message' data-member-account-id='<%= member_account_id %>' data-member-fullname='<%= propername %>'><i class='icon-envelope'></i> Send PM &nbsp;</button> \
				<button class='btn btn-super-tiny btn-genealogy-upgrade' data-member-account-id='<%= member_account_id %>' data-member-fullname='<%= propername %>'><i class='icon-arrow-up'></i> Upgrade &nbsp;</button> \
			</div> \
		</div> \
	</div>";
		...
		genealogy.req.downline_handler = b.request({
			...
			on_success: function(data, status) {
				if (data.status == 'ok') {
					...
					genealogy.req.downline_handler = b.request({
						with_overlay: false,
						url: genealogy.req.downline_url+'_count_expanded',
