...
//$config['admin_base_url']	= HTTP_PROTOCOL . 'cp.mitsukoshimotors.com';
...
$config['img_url'] 			= '/assets/img'; // update to change assets location
$config['media_url'] 			= '/assets/media'; // update to change assets location
...
|
*/
$config['encryption_key'] = 'b3y0nd8453';
