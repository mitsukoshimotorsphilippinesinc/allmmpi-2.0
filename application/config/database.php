...
$db['spare_parts']['database'] = 'mmpi_spare_parts';
...
$db['human_relations']['database'] = 'mmpi_human_relations';
...
$db['dpr']['hostname'] = 'localhost';
$db['dpr']['username'] = 'root';
$db['dpr']['password'] = '';
$db['dpr']['database'] = 'mmpi_dpr';
...
$db['warehouse']['database'] = 'mmpi_warehouse';
...
$db['operations']['hostname'] = 'localhost';
$db['operations']['username'] = 'root';
$db['operations']['password'] = '';
$db['operations']['database'] = 'mmpi_operations';
...
$db['information_technology']['hostname'] = 'localhost';
$db['information_technology']['username'] = 'root';
$db['information_technology']['password'] = '';
$db['information_technology']['database'] = 'mmpi_information_technology';
...
// for quick development not related to this project
$db['hrisdb']['hostname'] = 'localhost';
$db['hrisdb']['username'] = 'root';
$db['hrisdb']['password'] = '';
$db['hrisdb']['database'] = 'hrisdb';
$db['hrisdb']['dbdriver'] = 'mysql';
$db['hrisdb']['dbprefix'] = '';
$db['hrisdb']['pconnect'] = FALSE;
$db['hrisdb']['db_debug'] = TRUE;
$db['hrisdb']['cache_on'] = FALSE;
$db['hrisdb']['cachedir'] = '';
$db['hrisdb']['char_set'] = 'utf8';
$db['hrisdb']['dbcollat'] = 'utf8_unicode_ci';
$db['hrisdb']['swap_pre'] = '';
$db['hrisdb']['autoinit'] = TRUE;
$db['hrisdb']['stricton'] = FALSE;
$db['hrisdb']['failover'] = array();
