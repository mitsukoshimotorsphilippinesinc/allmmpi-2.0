<!--h2>Add New Navigation  <a href='/admin/navigations' class='btn' >Back</a></h2>
<hr/-->
<form action='/admin/navigations/add' method='post' class='form-inline'>
<fieldset >
	...
	<div class="control-group <?= $this->form_validation->error_class('parent_id'); ?>">
		...
		<div class="controls">
			<?php
				...
				echo form_dropdown('parent_id', $options, set_value('parent_id'), $extra);
	...
	<div class="control-group <?= $this->form_validation->error_class('code') ?>">
		...
		<div class="controls">
			<input type="text" class='span4' placeholder="Navigation Code" name="code" id="code" value="<?= set_value('code') ?>">		
		</div>
	...
	<div class="control-group <?= $this->form_validation->error_class('title') ?>">
		...
		<div class="controls">
			<input type="text" class='span4' placeholder="Name" name="title" id="title" value="<?= set_value('title') ?>">			
		</div>
	...
	<div class="control-group <?= $this->form_validation->error_class('url') ?>">
		...
		<div class="controls">
			<input type="text" class='span4' placeholder="Link" name="url" id="url" value="<?= set_value('url') ?>">			
		</div>
