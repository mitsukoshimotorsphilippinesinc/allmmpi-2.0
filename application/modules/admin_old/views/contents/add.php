...
<!--h2>Add New Content  <a href='/admin/contents' class='btn btn-large' >Back</a></h2>
<hr/-->

<div class='alert alert-info'><h3>Add New Content <a a class='btn return-btn' style='float:right;margin-right:-30px;' >Back to Contents Dashboard</a></h3></div>

<form action='/admin/contents/add' method='post' class='form-inline'>
	<fieldset >
		<div class="control-group <?= $this->form_validation->error_class('title') ?>">
			...
			<div class="controls">
				<input type="text" class='span6' placeholder="" name="title" id="title" value="<?= set_value('title') ?>">
		...
		<div class="control-group <?= $this->form_validation->error_class('content_type') ?>">
			...
			<div class="controls">
				<?php
					...
					echo form_dropdown('content_type', $options, set_value('content_type'),'class="span2"');
				?>
		...
		<div class="control-group <?= $this->form_validation->error_class('thumb') ?>">
			...
			<div class="controls">
				<input type="text" class='span6' placeholder="" name="thumb" id="thumb" value="<?= set_value('thumb') ?>">
		...
		<div class="control-group <?= $this->form_validation->error_class('excerpt') ?>">
			...
			<div class="controls">
				<textarea name="excerpt" id="excerpt" class="input-xlarge span10" rows="5"><?= set_value('excerpt') ?></textarea>
		...
		<div class="control-group <?= $this->form_validation->error_class('is_active'); ?>">
			...
			<div class="controls">
				<?php
					...
					echo form_dropdown('is_active', $options, set_value('is_active'), $extra);
