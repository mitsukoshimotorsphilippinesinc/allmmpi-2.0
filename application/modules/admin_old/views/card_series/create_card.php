<form>
	<fieldset >
		...
		<div  class="control-label">
			...
			<input id="quantity" class="span2" type="text" value="" name="quantity" placeholder="1 - 20000" maxlength="5">
		</div>	
		<span class='label label-important' id='quantity_error' style='display:none;'>Quantity must be between 1 to 20000.</span>
		
		<div  class="control-label">
			<label><strong>Preferred RN Prefix <em>(optional)</em></strong></label>
			<input id="rn_prefix" class="span2" type="text" value="" name="rn_prefix" placeholder="ABC" maxlength="3">
		</div>	
		<span class='label label-important' id='rn_prefix_error' style='display:none;'>Prefix must be 3 characters.</span>
	</fieldset>
</form>
