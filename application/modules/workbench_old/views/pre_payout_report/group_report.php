...
<script type="text/javascript">
	...
	download.init = function(){
		beyond.request({
			url: '/workbench/pre_payout_report/get_groups',
			data: {
	...
	download.processList = function(){
		...
		beyond.request({
			url: '/workbench/pre_payout_report/start_group_report_download_job',
			data: {
				'group_id' : group_id[0],
				'start_date': download.current_start_date,
				'end_date': download.current_end_date
	...
	download.pollingCheck = function(){
		...
		beyond.request({
			url: '/workbench/pre_payout_report/check_group_report_job_status',
			data: {
	...
	download.mergeDownload = function(){
		beyond.request({
			url: '/workbench/pre_payout_report/merge_download_segmented_excel',
			data: {
				'start_date': download.current_start_date,
				'end_date': download.current_end_date
			},
