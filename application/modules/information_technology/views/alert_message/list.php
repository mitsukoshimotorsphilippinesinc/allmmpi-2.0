...
<table class='table table-striped table-bordered'>
	...
	<?php foreach ($alert_messages as $am): ?>
		...
		<tr>
			...
			<td>
				<a href='/information_technology/systems/alert_message/view/<?= $a->message_id ?>' class='btn btn-small btn-info' title="View"><i class="icon-search icon-white"></i></a>
				<a href='/information_technology/systems/alert_message/edit/<?= $a->message_id ?>' class='btn btn-small btn-primary' title="Edit"><i class="icon-pencil icon-white"></i></a>
				<a href='/information_technology/systems/alert_message/delete/<?= $a->message_id ?>' class='btn btn-small btn-danger' title="Delete"><i class="icon-remove icon-white"></i></a>
			</td>
		</tr>
	<?php endforeach; ?>
	<?php endif; ?>
