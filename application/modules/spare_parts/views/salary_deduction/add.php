...
<form id="submit_form" action='<?= $submitURL ?>' method='post' class='form-inline'>
	<fieldset >
		...
		<div class="row-fluid">
			<div class="span6">
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						$details_content = get_requester_details($salary_deduction_details->id_number, "employee");
				...
				<div class="row-fluid">
					<div class="span11">
						<div class="control-group <?= $this->form_validation->error_class('remarks') ?>">
							...
							<div class="controls">
								<?php if(!$isAdd): ?>
								<textarea class='span8' rows="4" placeholder="" name="current_requester_remarks" readonly><?= $salary_deduction_details->remarks ?></textarea>
								<br/><br/>
			...
			<div class="span5">
				<label style="display:none;"><strong>From Warehouse:</strong></label>
				<br/>
				<?php if(!$isAdd):

					$warehouse_options = array();
					if ($salary_deduction_details->warehouse_id == 0)
				...
				?>
				<?= form_dropdown('add_item_warehouse',$warehouse_options, set_value('add_item_warehouse',$salary_deduction_details->warehouse_id),'id="add_item_warehouse" style="display:none;"') ?>
				<?php elseif($isAdd): 
					$warehouse_options = array();
					$warehouse_options = array('0' => 'Select a Warehouse...');
					foreach ($warehouse_details as $wd) {
				...
				<?= form_dropdown('add_item_warehouse',$warehouse_options, NULL,'id="add_item_warehouse" style="display:none;"') ?>
				<?php endif; ?>

				<br/>
				<br/>
				<label style="display:none;"><strong>Motorcycle Brand/Model:</strong></label>
				<br/>
				<?php if(!$isAdd):

					$brand_model_options = array();
					if ($salary_deduction_details->motorcycle_brand_model_id == 0)
					...
					echo form_dropdown('add_item_brandmodel',$brand_model_options, set_value('add_item_brandmodel',$salary_deduction_details->motorcycle_brand_model_id),'id="add_item_brandmodel" style="display:none;"');
				?>
				<?php elseif($isAdd):
					$brand_model_options = array();
					$brand_model_options = array('0' => 'Select a Brand/Model...');
				...
				?>
				<?= form_dropdown('add_item_brandmodel',$brand_model_options, NULL,'id="add_item_brandmodel" style="display:none;"') ?>
				<?php endif; ?>
				<br/>
				<br/>
				<label style="display:none;"><strong>Engine:</strong></label>
				<br/>

				<?php if(!$isAdd): ?>
				<input name="engine" id="engine" class="" style="display:none;" placeholder="Enter Engine Number..." value="<?= $salary_deduction_details->engine ?>" />
				<?php elseif($isAdd): ?>
				<input name="engine" id="engine" class="" style="display:none;" placeholder="Enter Engine Number..." />
				<?php endif; ?>

				<br/>
				<br/>
				<label style="display:none;"><strong>Chassis:</strong></label>
				<br/>

				<?php if(!$isAdd): ?>
				<input name="chassis" id="chassis" class="" style="display:none;" placeholder="Enter Chassis Number..." value="<?= $salary_deduction_details->chassis ?>" />
				<?php elseif($isAdd): ?>
				<input name="chassis" id="chassis" class="" style="display:none;" placeholder="Enter Chassis Number..." />
				<?php endif; ?>
		...
		<div class="controls" align="right">
			<!--a id='submit_order' class="btn btn-primary">Save Salary Deduction</a-->
