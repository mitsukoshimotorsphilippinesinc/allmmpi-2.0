...
<?php
	...
	if ($warehouse_request_details->motorcycle_brand_model_id > 0) {
		$motor_details = $this->warehouse_model->get_motorcycle_brand_model_class_view_by_id($warehouse_request_details->motorcycle_brand_model_id);
	...
	<table  class='table table-bordered'>
		...
		<tbody>
			...
			<tr>
				...
				<td><?= $warehouse_request_details->engine ?></td>
			</tr>	
			<tr>
				<td><strong>POSITION:</strong></td>
				<td><?= $details_content->position_name ?></td>
				<td><strong>CHASSIS:</strong></td>
				<td><?= $warehouse_request_details->chassis ?></td>
			</tr>	
			<tr>
				<td><strong>EMAIL:</strong></td>
				<td><?= $details_content->email_address ?></td>
				<td><strong>STATUS:</strong></td>
				<td><?= $warehouse_request_details->status ?></td>
			</tr>	
			<tr>
		...
		$("#btn_item_search").click(function(e) {
			...
			b.request({
				...
				data: {
					...
					"request_id": <?= $warehouse_request_details->warehouse_request_id ?>,
