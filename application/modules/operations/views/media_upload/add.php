...
<h2>Add New Media Upload  <a href='/operations/media_upload' class='btn btn-small' style="float:right; margin-top: 5px; margin-right: -30px;">Back</a></h2>
<hr/>
<form action='/operations/media_upload/add' method='post' class='form-horizontal'>
	<fieldset >
		...
		<div class="control-group <?= $this->form_validation->error_class('description') ?>">
			...
			<div class="controls">
				<input type="text" class='span6' placeholder="" name="description" id="description" value="<?= $this->form_validation->set_value('description') ?>">
		...
		<div class="control-group <?= $this->form_validation->error_class('is_display') ?>">
			<label class="control-label" for="is_display">Display? <em>*</em></label>
			<div class="controls">
				<?php
				
				$options = array('' => 'Please Choose', '1' => 'Yes', '0' => 'No');
				
				echo form_dropdown("is_display", $options, set_value('is_display'),"id='is_display' style='width:auto;'");
		...
		<div class="control-group">
			<div class="controls">
				<button id="submit_media_upload" type="submit" class="btn btn-primary">Add New Media Upload</button>
			</div>
		</div>
	</fieldset>
</form>
