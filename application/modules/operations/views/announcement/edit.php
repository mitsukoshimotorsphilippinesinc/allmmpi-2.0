...
<h2>Edit Announcement  <a href='/operations/announcement' class='btn btn-small' style="float:right; margin-top: 5px; margin-right: -10px;">Back</a></h2>
<hr/>
<?php if (empty($announcement)): ?>
<h3>Announcement not found.</h3>
<?php else: ?>
<form action='/operations/announcement/edit/<?= $announcement->announcement_id ?>' method='post' class='form-horizontal'>
	<fieldset >
		<div class="control-group <?= $this->form_validation->error_class('title') ?>">
			<label class="control-label" for="title">Title <em>*</em></label>
			<div class="controls">
				<input type="text" class='span6' placeholder="" name="title" id="title" value="<?= set_value('title',$announcement->title) ?>">
		...
		<div class="control-group <?= $this->form_validation->error_class('body') ?>">
			...
			<div class="controls">
				<div class=''>
					<textarea id='body' class='editor' name="body"><?= $this->form_validation->set_value('body',$announcement->body) ?></textarea>
				</div>
		...
		<div class="control-group <?= $this->form_validation->error_class('is_published') ?>">
			...
			<div class="controls">
				...
				echo form_dropdown("is_published", $options, set_value('is_published',$announcement->is_published),"id='is_published' style='width:auto;'");
		...
		<div class="control-group">
			<div class="controls">
				<button id="submit_announcement" type="submit" class="btn btn-primary">Update Announcement</button>
			</div>
		</div>
	</fieldset>
</form>
