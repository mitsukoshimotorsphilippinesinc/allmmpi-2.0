...
<div class="alert alert-info">
	<h2>Edit Announcement  <a href='/cms/announcements' class='btn btn-small' style="float:right; margin-top: 5px; margin-right: -30px;">Back</a></h2>
</div>
<hr/>
<?php if (empty($announcement)): ?>
<h3>Announcement not found.</h3>
<?php else: ?>
<form action='/cms/announcements/edit/<?= $announcement->announcement_id ?>' method='post' class='form-horizontal'>
	<fieldset >
