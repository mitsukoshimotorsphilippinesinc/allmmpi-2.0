...
<div class="alert alert-info">
	<h2>Add New Announcement  <a href='/cms/announcements' class='btn btn-small' style="float:right; margin-top: 5px; margin-right: -30px;">Back</a></h2>
</div>
<hr/>
<form action='/cms/announcements/add' method='post' class='form-horizontal'>
	<fieldset >
		...
		<div class="control-group">
			<div class="controls">
				<button id="submit_announcements" type="submit" class="btn btn-primary">Add New Announcement</button>
			</div>
		</div>
	</fieldset>
</form>
