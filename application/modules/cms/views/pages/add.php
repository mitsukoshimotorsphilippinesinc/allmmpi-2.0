...
<h2>Add New Page  <a href='/cms/pages' class='btn btn-small' >Back</a></h2>
<hr/>
<form action='/cms/pages/add' method='post' class='form-horizontal'>
	<fieldset >
		...
		<div class="control-group <?= $this->form_validation->error_class('body') ?>">
			...
			<div class="controls">
				<div class=''>
					<textarea name="body" id="body" class="span8" rows="20"><?= $this->form_validation->set_value('body') ?></textarea>
				</div>
		...
		<div class="control-group <?= $this->form_validation->error_class('excerpt') ?>">
			...
			<div class="controls">
				<div class=''>
					<textarea name="excerpt" id="excerpt" class="span8" rows="10"><?= $this->form_validation->set_value('excerpt') ?></textarea>
				</div>
