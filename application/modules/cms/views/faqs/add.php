...
<div class="alert alert-info">
	<h2>Add FAQ  <a href='/cms/faqs' class='btn btn-small' style="float:right;margin-top:5px;margin-right:-30px;">Back</a></h2>
</div>
<hr/>
<form action='/cms/faqs/add' method='post' class='form-horizontal'>
	<fieldset >
		<div class="control-group <?= $this->form_validation->error_class('question') ?>">
			...
			<div class="controls">
				<input type="text" class='span6' placeholder="" name="question" id="question" value="<?= set_value('question') ?>">
