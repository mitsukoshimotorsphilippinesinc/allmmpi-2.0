...
<h2>Add New Testimonials  <a href='/cms/testimonials' class='btn btn-small' >Back</a></h2>
<hr/>
<form action='/cms/testimonials/add' method='post' class='form-horizontal'>
	<fieldset >
		<div class="control-group <?= $this->form_validation->error_class('member_name') ?>">
			...
			<div class="controls">
				<input type="text" class='span6' placeholder="" name="member_name" id="member_name" value="<?= set_value('member_name') ?>">
		...
		<div class="control-group <?= $this->form_validation->error_class('member_details') ?>">
			...
			<div class="controls">
				<input type="text" class='span6' placeholder="" name="member_details" id="member_details" value="<?= set_value('member_details') ?>">
		...
		<div class="control-group <?= $this->form_validation->error_class('is_approved') ?>">
			...
			<div class="controls">
				...
				echo form_dropdown("is_approved", $options, set_value('is_approved'),"id='is_approved' style='width:auto;'");
