<div class="alert alert-info">
	<h2>Media Uploads <a href='/cms/media_uploads/add' class='btn btn-small' style="float:right; margin-top: 5px; margin-right: -30px;"><i class="icon-plus"></i><span> Add New</span></a></h2>
</div>
<hr/>

<div id="search_container">
	<form id='search_details' method='get' action ='/cms/media_uploads' class="form-inline">
...
<table class='table table-striped table-bordered'>
	...
	<?php foreach ($media_uploads as $a): ?>
		<tr>
			...
			<td>
				<a href='/cms/media_uploads/view/<?= $a->media_upload_id ?>' class='btn btn-small btn-info' title="View"><i class="icon-search icon-white"></i></a>
				<a href='/cms/media_uploads/edit/<?= $a->media_upload_id ?>' class='btn btn-small btn-primary' title="Edit"><i class="icon-pencil icon-white"></i></a>
				<a href='/cms/media_uploads/delete/<?= $a->media_upload_id ?>' class='btn btn-small btn-danger' title="Delete"><i class="icon-remove icon-white"></i></a>
			</td>
		</tr>
	<?php endforeach; ?>
	<?php endif; ?>
