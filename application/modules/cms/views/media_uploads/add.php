...
<div class="alert alert-info">
	<h2>Add New Media Upload  <a href='/cms/media_uploads' class='btn btn-small' style="float:right; margin-top: 5px; margin-right: -30px;">Back</a></h2>
</div>
<hr/>
<form action='/cms/media_uploads/add' method='post' class='form-horizontal'>
	<fieldset >
