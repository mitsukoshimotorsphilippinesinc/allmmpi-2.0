...
<h2>Add New Featured Promo  <a href='/cms/promos' class='btn btn-small' >Back</a></h2>
<hr/>
<form action='/cms/promos/add' method='post' class='form-horizontal'>
	<fieldset >
		<div class="control-group <?= $this->form_validation->error_class('promo_title') ?>">
			...
			<div class="controls">
				<input type="text" class='span6' placeholder="" name="promo_title" id="promo_title" value="<?= set_value('promo_title') ?>">
		...
		<div class="control-group <?= $this->form_validation->error_class('promo_description') ?>">
			...
			<div class="controls">
				<div class=''>
					<textarea name="promo_description" id="promo_description" class="input-xlarge span10" rows="20"><?= $this->form_validation->set_value('promo_description') ?></textarea>
				</div>
		...
		<div class="control-group <?= $this->form_validation->error_class('promo_text') ?>">
			...
			<div class="controls">
				<div class=''>
					<textarea name="promo_text" id="promo_text" class="input-xlarge span10" rows="8"><?= $this->form_validation->set_value('promo_text') ?></textarea>
				</div>
		...
		<div class="control-group">
			<div class="controls">
				<button id="submit_promo" type="submit" class="btn btn-primary">Add New Promo</button>
			</div>
		</div>
	</fieldset>
</form>
<script type="text/javascript">
	...
	var start_date = '<?=set_value('active_start')?>';
	var end_date = '<?=set_value('active_end')?>';
