...
/*if (!CLI)
	define('ENVIRONMENT', (isset($_SERVER['BEYOND_ENV']) ? $_SERVER['BEYOND_ENV'] : 'development'));
else
 ...
 */
	...
	define('SITE_DOMAIN', isset($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : '');
